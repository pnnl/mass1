...
set y2label "Elevation, feet" 0.000000,0.000000  ""
set yrange [ 0 : 220000 ] noreverse nowriteback  # (currently [-10.0000:10.0000] )
...
set tmargin -1
set locale "C"
plot 'RIS-Flow.dat' using 1:3 title "Pool Inflow" with lines 1, \
     'WAN-Flow.dat' using 1:3 title "Pool Outflow" with lines 3, \
     'WAN-FBE.dat' using 1:3 axes x1y2 title "Forebay Stage" with linespoints 7
#    EOF
