...
set ylabel "Elevation, feet" 0.000000,0.000000  ""
set y2label "" 0.000000,0.000000  ""
set yrange [ * : * ] noreverse nowriteback  # (currently [0.00000:220000.] )
...
set tmargin -1
set locale "C"
plot '../BCFiles/WAN-FBE.dat' using 1:3 title 'Observed' with linespoints 1,\
     'ts182.out' using 1:3 title 'Simulated' with lines 3
#    EOF
