...
set xlabel "River Miles from GCL" 
set xlabel  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set x2label "" 
set x2label  offset character 0, 0, 0 font "" textcolor lt -1 norotate
set xrange [ 90.000 : 160.000 ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback  # (currently [110.000:170.000] )
set ylabel "Elevation, ft" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "Cross Section Average Velocity, ft/s" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ * : * ] noreverse nowriteback  # (currently [1050.00:1350.00] )
set y2range [ * : * ] noreverse nowriteback  # (currently [0.00000:16.0000] )
set zlabel "" 
...
GNUTERM = "x11"
plot "<tail -n 574 profile1.out" using 4:5 axes x1y1 title "Water Surface" with lines ls 1, "" using 4:13 axes x1y1 title "Thalweg" with lines ls 7, "" using 4:7 axes x1y2 title "Velocity" with lines ls 3
#    EOF
