...
# Last Change: Thu Mar 16 13:53:51 2000 by William A. Perkins <perk@mack.pnl.gov>
# -------------------------------------------------------------
# $Id$
...
plot 7200000 notitle with lines 0, \
     ...
     "<awk '$0 !~ /^#/ {sum=sum+$4*$8*144; print $1, $2, sum; }' ts1149.out" using 1:3 title 'Outflow' with lines 3
