...
# Last Change: Fri Oct 26 09:54:13 2007 by William A. Perkins <perk@mcperk.pnl.gov>
# -------------------------------------------------------------
# $Id$
...
plot "<awk '/Time: 03:00/, /Time: 05:/ { if ($0 !~ /^ *#/) {print $4, $13;} }' profile1.out" using (10656 - $1):2 title "Thalweg" with linespoint 3, \
