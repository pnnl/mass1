...
# Last Change: Wed Jan 13 11:21:34 1999 by William A. Perkins <perk@erebus.pnl.gov>
# -------------------------------------------------------------
...
# DEBUG = -g3 -Ofast -DEBUG:trap_uninitialized=ON
DEBUG = -g3 -O
# FLAGS = $(DEBUG) -ansi -r10000 -TARG:platform=IP30
FLAGS = $(DEBUG) -r10000 -TARG:platform=IP30
F90FLAGS = $(FLAGS)
LIBLOC = 
